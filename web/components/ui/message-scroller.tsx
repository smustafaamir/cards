...
function MessageScrollerViewport({
  ...
  return (
    <MessageScrollerPrimitive.Viewport
      ...
      className={cn(
        "size-full min-h-0 min-w-0 overflow-y-auto overscroll-contain [scrollbar-width:thin] [scrollbar-color:#e4e4e7_transparent] data-autoscrolling:[scrollbar-color:transparent_transparent]",
        className
      )}
      {...props}
    />
      ...
      render={
        render ?? (
          <Button
            variant="outline"
            size="sm"
            className="size-8 rounded-full border-[#e4e4e7] bg-white shadow-sm hover:bg-[#fafafa]"
          />
        )
      }
      {...props}
